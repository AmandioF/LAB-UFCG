...
public class SistemaTest {
	...
	public void testCadastraApostaApostadorNulo() {
		sistema = new Sistema(10,  0.01);
		sistema.cadastrarCenario("O pre√ßo do a√ßucar vai diminuir");
	...
	public void testCadastrarApostaSeguraValorNulo() {
		sistema = new Sistema(10,  0.01);
		sistema.cadastrarCenario("O preÁo do aÁucar vai diminuir");
	...
	public void testCadastraCenario() {
		sistema = new Sistema(10, 0.01);
		assertEquals("Indice de cadastro incorreto",1 ,sistema.cadastrarCenario("O pre√ßo do a√ßucar vai diminuir"));
	...
	public void testExibirCenarios1() {
		sistema = new Sistema(10, 0.01);
		sistema.cadastrarCenario("O pre√ßo do a√ßucar vai diminuir");
		assertEquals("String incorreta","1 - O pre√ßo do a√ßucar vai diminuir - Nao finalizado\n" ,sistema.exibirCenarios());
	...
	public void testExibirCenario() {
		sistema = new Sistema(10, 0.01);
		sistema.cadastrarCenario("O pre√ßo do a√ßucar vai diminuir");
		assertEquals("String incorreta","1 - O pre√ßo do a√ßucar vai diminuir - Nao finalizado" ,sistema.exibirCenario(1));
	...
	public void testValorTotalDeApostas() {
		sistema = new Sistema(10, 0.1);
		sistema.cadastrarCenario("O pre√ßo do aÁucar vai diminuir");
		sistema.cadastrarAposta(1, "Klebinho", 10, "VAI ACONTECER");
