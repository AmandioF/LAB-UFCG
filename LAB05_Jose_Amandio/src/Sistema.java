...
public class Sistema {
	...
	/**
     * analisa os parametros, afim de dizer se est�o aptos a serem usados por outros metodos
     * caso n�o seja, ele retorna um erro ao sistema
     * 
	...
	/**
	 * cadastra um cenario bonus a partir da sua descri��o e bonus
	 * 
	 * @param descricao descri��o para cria��o do cenario bonus
    ...
    * Toda Aposta assegurada por Taxa recebe um parametro de cenario, Apostador, valor, previsao, seguro e custo.
    * 
    * @param cenario indice do cenario que foi feita a aposta
    * @param apostador pessoas que esta fazendo a aposta
    * @param valor valor da aposta feita pelo apostador
    ...
    */
    ...
    public void alterarSeguroValor(int cenario, int apostaAssegurada, int valor) {
    	this.validar("Erro na altera��o de seguro por valor:", cenario);
    	this.validar("Erro na altera��o de seguro por valor:", apostaAssegurada);
    	if(valor < 1) {
	...
	/**
	 * retorna a representa��o em string com todas as apostas de um determinado cenario
	 * 
	 * @param cenario cenario que ser� pritando as apostas
	 * 
	 ...
	 * 
	 * @param ocorreu booleano que determinar� se o cenario ocorreu ou não
	 */ 
	...
	/**
	 * Retorna o valor total de um cen�rio encerrado
	 * 
	 * @param cenario canario que ter� seu valor exibido
	 * 
	...
	/**
	 * Retorna o valor total de um cen�rio encerrado que ser� destinado as apostas vencedoras
	 * 
	 * @param cenario cenario que ter� o valor distribuido
	 * 
